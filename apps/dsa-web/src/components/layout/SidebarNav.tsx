...
import { BarChart3, BookOpen, BriefcaseBusiness, Home, Landmark, LogOut, MessageSquareQuote, ScrollText, Settings2, TrendingUp } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'market', label: '大盘', to: '/market-review', icon: TrendingUp },
  { key: 'knowledge', label: '知识库', to: '/knowledge', icon: BookOpen },
  { key: 'capital-flow', label: '资金流', to: '/capital-flow', icon: Landmark },
